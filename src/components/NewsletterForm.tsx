    ...
    <div className="bg-white rounded-lg shadow-lg p-6 space-y-6">
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <label className="block text-sm font-medium text-gray-700">Newsletter Titel</label>
          <input
            value={data.title}
            onChange={(e) => onChange({ ...data, title: e.target.value })}
            className="w-full px-3 py-2 border rounded-md"
            placeholder="e.g., H2 Update"
          />
        </div>

        <div className="space-y-2">
          <label className="block text-sm font-medium text-gray-700">Newsletter Datum</label>
          <input
            type="date"
            value={data.date}
        ...
        <div className="space-y-2">
          <label className="block text-sm font-medium text-gray-700">Einführungstext</label>
          <textarea
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <label className="block text-sm font-medium text-gray-700">Abschlussnachricht</label>
          <textarea
